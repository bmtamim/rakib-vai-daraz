...
<div class="topbar-nav">
	...
	<div class="currency">
		 <a href="#">৳ BDT<i class="ion-ios-arrow-down"></i></a>
		 <ul>
			  <li><a href="#">$ USD</a></li>
		 </ul>
	</div>
				...
				<div class="col-xl-2 col-md-12">
					<div class="site-logo">
						<a href="{{route('home')}}"><img
								 src="{{ asset('public/frontend/desktop/images/logo/logo-white.png') }}"
								 alt="Nikado"></a>
					</div>
				</div>
						...
						<nav>
							<ul class="categori-menu-list menu-hidden">
								<li><a href="shop.html"><span><img
												 src="{{ asset('public/frontend/desktop/images/icons/1.png') }}"
												 alt="menu-icon"></span>Electronics<i
								...
								<li><a href="shop.html"><span><img
												 src="{{ asset('public/frontend/desktop/images/icons/2.png') }}"
								...
								<li><a href="shop.html"><span><img
												 src="{{ asset('public/frontend/desktop/images/icons/3.png') }}"
								...
								<li><a href="shop.html"><span><img
												 src="{{ asset('public/frontend/desktop/images/icons/4.png') }}"
								...
								<li><a href="shop.html"><span><img
												 src="{{ asset('public/frontend/desktop/images/icons/5.png') }}"
								...
								<li><a href="shop.html"><span><img
												 src="{{ asset('public/frontend/desktop/images/icons/6.png') }}"
												 alt="menu-icon"></span>Beauty</a>
								</li>
								<li><a href="shop.html"><span><img
												 src="{{ asset('public/frontend/desktop/images/icons/7.png') }}"
												 alt="menu-icon"></span>Sport & tourism</a>
								</li>
								<li><a href="shop.html"><span><img
												 src="{{ asset('public/frontend/desktop/images/icons/8.png') }}"
												 alt="menu-icon"></span>Fruits & Veggies</a></li>
								<li><a href="shop.html"><span><img
												 src="{{ asset('public/frontend/desktop/images/icons/9.png') }}"
												 alt="menu-icon"></span>Computer & Laptop</a></li>
								<li><a href="shop.html"><span><img
												 src="{{ asset('public/frontend/desktop/images/icons/10.png') }}"
												 alt="menu-icon"></span>Meat & Seafood</a></li>
								<li><a href="shop.html"><span><img
												 src="{{ asset('public/frontend/desktop/images/icons/12.png') }}"
												 alt="menu-icon"></span>Samsung</a></li>
								<li><a href="shop.html"><span><img
												 src="{{ asset('public/frontend/desktop/images/icons/11.png') }}"
												 alt="menu-icon"></span>Sanyo</a></li>
							</ul>
						</nav>
					</div>
				</div>
										...
										<ul>
											...
											<li><a href="#">Blog</a>
												<ul>
													...
													<li><a href="blog.html">Sidebar right</a></li>
													<li><a href="single-blog.html">Image Format</a></li>
													<li><a href="single-blog-gallery.html">Gallery Format</a>
													</li>
													<li><a href="single-blog-audio.html">Audio Format</a></li>
													<li><a href="single-blog-video.html">Video Format</a></li>
												</ul>
