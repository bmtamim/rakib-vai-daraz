				...
				<div class="slider-area-inner">
					...
					<div class="slider-inner">
						<div id="mainSlider" class="nivoSlider nevo-slider">
							<img src="{{ asset('public/frontend/desktop/images/slider/1.jpg') }}" alt="main slider"
								  title="#htmlcaption1"/>
							<img src="{{ asset('public/frontend/desktop/images/slider/2.jpg') }}" alt="main slider"
								  title="#htmlcaption2"/>
						</div>
			...
			<div class="slider-banner-area col-sm-12">
				<div class="slider-banner">
					<div class="slider-single-banner">
						<a href="shop.html">
							<img src="{{ asset('public/frontend/desktop/images/banner/banner1.png') }}" alt="Banner">
						</a>
					</div>
				</div>
				<div class="slider-banner">
					<div class="slider-single-banner">
						<a href="shop.html">
							<img src="{{ asset('public/frontend/desktop/images/banner/banner2.png') }}" alt="Banner">
						</a>
					</div>
				</div>
			</div>
