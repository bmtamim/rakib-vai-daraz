...
//		} );
		...
		$new_products          = Cache::remember( 'best_selling_products', 86400, function () {
			return \App\Models\Product::where( 'published', 1 )->orderBy( 'created_at', 'desc' )->limit( 20 )->get();
		} );
		$agent                 = new Agent();
		if ( $agent->isMobile() ) {
			return view( 'frontend.mobile.home', compact( 'best_selling_products', 'new_products' ) );
		}

		return view( 'frontend.desktop.home', compact( 'best_selling_products', 'new_products' ) );
	}
	...
	public function registration( Request $request ) {
		...
		return view( 'frontend.mobile.auth.register' );
	...
	public function cart_login( Request $request ) {
		...
		if ( $request->get( 'phone' ) != null ) {
			$user = User::whereIn( 'user_type', [
				'customer',
				'seller'
			] )->where( 'phone', "+{$request['country_code']}{$request['phone']}" )->first();
